...
/* 各种不同类型的 tag 颜色 */
.pub-tag-arxiv  { background: #d9534f; }   /* 红色 arXiv */
.pub-tag-github { background: #555555; }   /* 深灰 GitHub */
.pub-tag-icml   { background: #7c2dd0; }   /* 紫色 ICML */
.pub-tag-preprint { background: #5cb85c; } /* 绿色 Preprint（如果你也想让它可点） */
</style>
